...
class Test_User_Navigation_Lk:

    #Переход в личный кабинет
    def test_navigation_lk(self, driver_chrome):
        ...
        #Проверяем что кнопка выхода отображается в личном кабинете 
        assert wait.until(EC.presence_of_element_located(TestLocators.LOGOUT_BUTTON)).is_displayed()
